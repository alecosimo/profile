...
//var url = "file:///home/alecosimo/watson/profile/compiledViews"
...
fsp.readFile('views/articles/articles.json', 'utf8')
	.then(articlesFiles => {
		...
		files.forEach((e, index) => {
			...
			ejs.renderFile("views/show-article.ejs", { article: e, articleBody: body, prevArt: files[index - 1], nextArt: files[index + 1] },
				{}, (err, str) => {
					if (err) { console.log(err); throw err; }
					fs.writeFile(e.name, str, (err) => {
